...
<div class="page-sidebar-wrapper">
		<div class="page-sidebar navbar-collapse collapse">
            ...
            <li>
					...
					<span class="title">Add/Edit Company</span>
					</a>
				</li>         
				<li  <?php if(
				...
				<li>
					<a href="employee_task_performed?cmd=list">
					<i class="icon-puzzle"></i>
			...
			<!-- END SIDEBAR MENU -->
           <link rel="stylesheet" href="http://contractortrackerapp.com/webapp/datepicker/jquery-ui.css">
	     	  <script src="http://contractortrackerapp.com/webapp/datepicker/jquery-1.10.2.js"></script>
		     <script src="http://contractortrackerapp.com/webapp/datepicker/jquery-ui.js"></script>		  
           <!--------  Employee Popup  ------------>
           <?php
												 ...
												 <form name="frm_task_performed" method="post"  action="employee_task_performed"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
													<div class="portlet-body">
											            ...
											            <tr>
											             <td>Date</td>
											             <td>
											                <input type="text" name="date_time" id="date_time_<?=$i?>"  value="<?=date("Y-m-d");?>" class="datepicker<?=$i?>">
											             </td>
											            </tr>
											            <tr>
