...
<div style="position:relative;bottom:74px">
		<a href="admin/index.php"  class="btn btn-info btn-lg btn-block">GO TO ADMIN PANEL &nbsp; <i class="fa fa-play-circle"></i></a>
...
<!-- START OF LOGIN FORM -->
		<form id="login-form" action="" class="form">
			...
			<div class="form-group">
				...
				<button type="submit" id="login-btn" onClick="login();return false;" class="btn btn-success btn-block">Signin &nbsp; <i class="fa fa-play-circle"></i></button>

			</div>
		</form>

<!-- END OF LOGIN FORM -->
		<a href="forget.php" class="btn btn-default">Forgot Password?</a>

	</div> <!-- /#login -->

	<a href="register.php" id="signup-btn" class="btn btn-lg btn-block">
		Create an Account
	</a>
